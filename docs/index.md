...
<div class="features">
  ...
  <div class="feature">
    ...
    <p>AI запоминает важные факты между чатами. Скажите «запомни ...» или включите автосводки — и AI будет учитывать контекст предыдущих разговоров.</p>
  </div>
...
<details>
<summary><strong>Как работает память AI?</strong></summary>
<p>В настройках есть раздел «Memory & Context». Когда память включена, AI сохраняет важные факты из разговоров и использует их в будущих чатах. Вы можете явно попросить AI запомнить что-то, написав «запомни ...» или «remember ...». Также можно включить автоматическое суммирование, и AI будет сам извлекать ключевые моменты из каждого разговора. Все данные хранятся только на вашем устройстве.</p>
</details>
